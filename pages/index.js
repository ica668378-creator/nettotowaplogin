...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>NETTOTO | Login Resmi: Menjelajah Jaringan Cuan Tanpa Batas</title>
        <meta name="description" content="NETTOTO adalah situs resmi terpercaya dengan akses login cepat, keamanan SSL 256-bit, dan dukungan 24/7. Daftar gratis sekarang." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href={D.logo} />
        <link rel="canonical" href={'https://' + D.domain + '/'} />
        <link rel="amphtml" href={'https://' + D.domain + '/amp/'} />
        <meta property="og:title" content="NETTOTO | Login Resmi: Menjelajah Jaringan Cuan Tanpa Batas" />
        <meta property="og:description" content="NETTOTO adalah situs resmi terpercaya dengan akses login cepat, keamanan SSL 256-bit, dan dukungan 24/7. Daftar gratis sekarang." />
        <meta property="og:image" content={D.logo} />
        <meta property="og:url" content={'https://' + D.domain} />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="NETTOTO | Login Resmi: Menjelajah Jaringan Cuan Tanpa Batas" />
        <meta name="twitter:description" content="NETTOTO adalah situs resmi terpercaya dengan akses login cepat, keamanan SSL 256-bit, dan dukungan 24/7. Daftar gratis sekarang." />
      ...
      <style jsx global>{`
        :root{--bg:#0a1628;--bg2:#0f1d32;--card:#162440;--primary:#c9a84c;--primary2:#b8953d;--accent:#e8d48b;--text:#e8e4d9;--muted:#8a9ab5;--border:rgba(201,168,76,.12);--r:6px}
        *{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
        ...
        header{position:sticky;top:0;z-index:50;background:#0a1628e8;backdrop-filter:blur(14px);border-bottom:1px solid var(--border)}
        ...
        .bp{background:var(--primary);color:#0a1628;box-shadow:0 4px 16px #c9a84c35}
        .bp:hover{background:var(--primary2);transform:translateY(-2px);box-shadow:0 6px 24px #c9a84c50}
        ...
        .badge{display:inline-flex;align-items:center;gap:8px;padding:6px 16px;border:1px solid var(--border);border-radius:99px;font-size:12px;color:var(--primary);background:#c9a84c10;margin-bottom:20px;font-weight:600}
        ...
        .bnr-card:hover{transform:translateY(-3px);box-shadow:0 8px 24px #c9a84c20}
        ...
        .sh .tg{display:inline-block;padding:5px 14px;border:1px solid var(--border);border-radius:var(--r);font-size:11px;color:var(--primary);background:#c9a84c08;margin-bottom:10px;font-weight:700;text-transform:uppercase;letter-spacing:1px}
        ...
        .fc:hover{transform:translateY(-4px);border-color:var(--primary);box-shadow:0 10px 30px #c9a84c15}
        .fc .ic{width:48px;height:48px;border-radius:var(--r);background:#c9a84c12;display:flex;align-items:center;justify-content:center;font-size:22px;margin-bottom:12px}
        ...
        .step .nm{width:46px;height:46px;border-radius:50%;background:var(--primary);color:#0a1628;display:flex;align-items:center;justify-content:center;font-weight:800;font-size:16px;margin:0 auto 10px}
        ...
        .cta{background:var(--primary);border-radius:var(--r);padding:48px 28px;text-align:center;color:#0a1628}
        ...
        .hero{background:linear-gradient(180deg,#0a1628,#162440)}.badge{border:1px solid #c9a84c;color:#c9a84c;letter-spacing:3px;text-transform:uppercase;font-size:10px}.bp{background:linear-gradient(90deg,#c9a84c,#e8d48b);color:#0a1628}.hero h1{letter-spacing:-1px}footer{background:#060e1a}
      `}</style>
      ...
      <main>
        <section className="hero"><div className="C">
          ...
          <h1>NETTOTO | Login Resmi: Menjelajah Jaringan Cuan Tanpa Batas</h1>
        ...
        <section className="bnr"><div className="C">
          <div className="bnr-grid">
            <a href={D.linkDaftar} className="bnr-card"><img src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=720&h=280&fit=crop" alt="NETTOTO - Promo 1" loading="lazy" /></a>
            <a href={D.linkDaftar} className="bnr-card"><img src="https://images.unsplash.com/photo-1582407947304-fd86f028f716?w=720&h=280&fit=crop" alt="NETTOTO - Promo 2" loading="lazy" /></a>
            <a href={D.linkDaftar} className="bnr-card"><img src="https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=720&h=280&fit=crop" alt="NETTOTO - Promo 3" loading="lazy" /></a>
          </div>
        </div></section>
